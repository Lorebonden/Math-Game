...
<head>
<meta charset="UTF-8">
<title>Block Game with Achievements & Save</title>
<style>
body {
...
<div class="achievement" id="ach-50correct">Answer 50 Correctly</div>
<div class="achievement" id="ach-superEasy">Play Super Easy Mode</div>
<div class="achievement" id="ach-superImpossible">Play Super Impossible Mode</div>
</div>
...
function setDifficulty(d){
    difficulty = d;
    // Achievement for playing modes
    if(d==="superEasy") document.getElementById("ach-superEasy").classList.add("unlocked");
    if(d==="superImpossible") document.getElementById("ach-superImpossible").classList.add("unlocked");
    newTask();
}
...
function updateAchievements(){
    ...
    if(correctAnswers>=50) document.getElementById("ach-50correct").classList.add("unlocked");
}
